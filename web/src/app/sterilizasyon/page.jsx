...
export default function SterilizasyonPage() {
  return (
      ...
      <aside className="fixed left-0 top-0 h-full w-64 bg-white border-r border-gray-200 z-20">
        ...
        <nav className="px-4 py-4">
          ...
          <div>
            ...
            <div className="space-y-1">
              ...
              <a href="/malzeme-takip" className="flex items-center gap-3 px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-md cursor-pointer">
                <Package className="w-4 h-4" />
                <span>Malzeme Takibi</span>
              </a>
              <a href="/kalite-kontrol" className="flex items-center gap-3 px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-md cursor-pointer">
        ...
        <div className="absolute bottom-6 left-4 right-4">
          <div className="bg-gray-50 rounded-md p-3 text-sm">
            <p className="text-gray-900 font-medium">Autoclave #1 - Ana Ünitesi</p>
            <div className="flex gap-2 mt-2">
              <button className="flex items-center gap-1 text-gray-600 hover:text-gray-900">
                <Copy className="w-3 h-3" />
                <span className="text-xs">Rapor Al</span>
              </button>
              <button className="flex items-center gap-1 text-gray-600 hover:text-gray-900">
        ...
        <header className="bg-white border-b border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between">
            <nav className="flex space-x-8">
              ...
              <a href="/sterilizasyon" className="text-blue-600 border-b-2 border-blue-600 pb-4 text-sm font-medium">
                Sterilizasyon
              </a>
