import { AlertTriangle, Clock, CheckCircle, Monitor, Thermometer, TestTube, Users, FileText, Scissors } from "lucide-react";
    ...
    <>
      ...
      <div className="grid grid-cols-1 gap-3">
        {filtered.map((n) => {
          ...
          return (
            <div key={n.id} className={`flex items-start gap-3 p-4 border rounded-lg bg-white`}>
              <div className={`mt-0.5 inline-flex h-7 w-7 items-center justify-center rounded ${palette}`}>
